    ...
    <div className="max-w-4xl mx-auto p-8 pb-32">
      <header className="mb-10 flex justify-between items-end">
        ...
        <div className="flex gap-3">
          <button className="px-6 py-2 rounded-xl bg-surface-container-high text-on-surface font-semibold text-sm hover:bg-surface-bright transition-colors">Reset Defaults</button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div className="group">
              ...
              <div className="relative">
                ...
                <input className="w-full pl-8 pr-4 py-3 bg-surface-container-high rounded-lg border-none focus:ring-1 focus:ring-primary text-on-surface font-mono" type="number" defaultValue="1500" />
              </div>
            ...
            <div className="group">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant">$</span>
                <input className="w-full pl-8 pr-4 py-3 bg-surface-container-high rounded-lg border-none focus:ring-1 focus:ring-primary text-on-surface font-mono" type="number" defaultValue="200" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="p-6 rounded-2xl bg-surface-container border border-outline-variant/10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="group">
              ...
              <input className="w-full px-4 py-3 bg-surface-container-high rounded-lg border-none focus:ring-1 focus:ring-primary text-on-surface font-mono" type="number" defaultValue="2" />
            </div>
            <div className="group">
              <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-2">Max Players</label>
              <input className="w-full px-4 py-3 bg-surface-container-high rounded-lg border-none focus:ring-1 focus:ring-primary text-on-surface font-mono" type="number" defaultValue="8" />
            </div>
          </div>
          <div className="mt-8 p-4 rounded-xl bg-surface-container-low border border-outline-variant/5">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="w-10 h-5 bg-primary-container rounded-full relative transition-colors">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="w-10 h-5 bg-surface-container-highest rounded-full relative transition-colors">
        ...
        <section className="md:col-span-2 p-6 rounded-2xl bg-surface-container border border-outline-variant/10">
          ...
          <div className="space-y-2">
            {[
              { id: 'double-rent', icon: 'palette', title: 'Double-Rent on Sets', desc: 'Rent is doubled when a player owns all properties of a color group.', active: true },
              { id: 'auctions', icon: 'sell', title: 'Mandatory Auctions', desc: 'Unpurchased properties must go to immediate auction.', active: true },
              { id: 'bankruptcy', icon: 'account_balance', title: 'Instant Bankruptcy', desc: 'Players are eliminated immediately when debts exceed assets.', active: false },
            ].map((rule) => (
              <div key={rule.id} className="flex items-center justify-between p-4 rounded-xl bg-surface-container-high/50 hover:bg-surface-container-high transition-colors group">
                ...
                <button className={`w-11 h-6 rounded-full relative transition-colors ${rule.active ? 'bg-secondary-container' : 'bg-surface-container-highest'}`}>
                  <span className={`absolute top-[2px] w-5 h-5 bg-white rounded-full transition-all ${rule.active ? 'left-[24px]' : 'left-[2px]'}`}></span>
                </button>
              </div>
            ))}
          </div>
        ...
        <section className="md:col-span-2 p-6 rounded-2xl bg-surface-container border border-outline-variant/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 rounded-xl bg-surface-container-low">
              ...
              <div className="flex items-center gap-4">
                <input className="flex-1 accent-tertiary" type="range" min="0" max="100" defaultValue="10" />
                <span className="text-sm font-mono text-tertiary">$10</span>
              </div>
            </div>
            <div className="p-4 rounded-xl bg-surface-container-low">
              <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-3">Bid Increment</label>
              <select defaultValue="$10 Scaled" className="w-full bg-surface-container-high border-none rounded-lg text-sm text-on-surface focus:ring-1 focus:ring-primary">
            ...
            <div className="p-4 rounded-xl bg-surface-container-low">
              ...
              <select defaultValue="30 Seconds" className="w-full bg-surface-container-high border-none rounded-lg text-sm text-on-surface focus:ring-1 focus:ring-primary">
